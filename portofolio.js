...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showContent(contentToShow, buttonToActivate) {
        const isActive = contentToShow.classList.contains('active')
        ...
        const rect = contentToShow.getBoundingClientRect();
            ...
            const offset = 150; // Contoh: scroll 50px di atas konten
